...
import org.ansj.lang.tire.GetWord;
...
public abstract class Analysis {
	...
	protected List<Term> parseStr(String temp) {
		...
		if("mysql".equals(MyStaticValue.userLibrarySource)) {
			UserDefineLibrary.reloadAmbiguityWord();
			UserDefineLibrary.reloadUserLibrary();
		}
		analysisStr(temp);
		return terms;
	}
